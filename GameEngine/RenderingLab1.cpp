...
{
	cube->initTexture("../Resources/Textures/wood.png",textureShader->GetProgramID());
	plane->initTexture("../Resources/Textures/tile.png",textureShader->GetProgramID());
	//sphere->initTexture("../Resources/Textures/green.jpg",textureShader->GetProgramID());
	torus->initTexture("../Resources/Textures/green.jpg",toonTexturedShader->GetProgramID());
...
void RenderingLab1::update()
{
	...
	cube->update(textureShader->modelLoc, dt);
	cube->render();
