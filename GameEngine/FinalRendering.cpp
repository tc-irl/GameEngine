...
//	cube->SetNormalTexture("../Resources/Textures/wood_normal.png");
...
//	TwAddVarRW(bar, "Parallax Scale", TW_TYPE_FLOAT, &cubeLight->parallaxScale, " step='0.1'group='Parallax Settings' label='Parallax Scale: '");
//	TwAddVarRW(bar, "Parallax Bias", TW_TYPE_FLOAT, &cubeLight->bias, " step='0.1'group='Parallax Settings' label='Bias: '");
