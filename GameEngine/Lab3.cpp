...
//	
//
//		//if(checkForSphereToBoxCollision(boundingCubes[0],spheres[0]) == true)
//		//{
...
////	for(int i = 0; i < 3; i++ ) 
////	{
////		if(sphere->position[i] < rigidBodies[0]->minExtents[i])
////		{
////			dmin += glm::pow(sphere->position[i] - cube->scale[i],2.0f);
////		}
////		else if(sphere->position[i] > rigidBodies[0]->maxExtents[i]) 
////		{
////			dmin += glm::pow(sphere->position[i] - cube->scale[i],2.0f);    
////		}
////	}
